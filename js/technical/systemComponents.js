var systemComponents = {
    ...
    'info-tab': {
        ...
        <br><br>
        Original: <a v-bind:href="'https://gitee.com/seac_blue/void-dimension'" target="_blank" class="link" v-bind:style = "{'font-size': '14px', 'display': 'inline'}" >Void Dimension</a> by Seako
        <br><br>
